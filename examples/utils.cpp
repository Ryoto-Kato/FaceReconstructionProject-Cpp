...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    //Check if the number of detected ladnmark and BFM registred landmarks are identical
    assert(ps_dlib_landmarks_vertexPos.size() == ps_bfm_landmarks_vertexPos.size() == ps_dlib_landmarks.size() && "Number of landmarks extracted form image must be equal to the ones form BFM");
