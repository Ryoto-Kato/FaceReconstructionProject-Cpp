...
{ 
    ...
    */
    ...
    std::tie(result_vertex_pos, result_vertex_rgb, result_triangle_list) = bfm.writeBFMmesh("../output/gen_mesh_test1.ply", estimated_coefs_shape, estimated_coefs_tex, estimated_coefs_exp ,_withExpression);
