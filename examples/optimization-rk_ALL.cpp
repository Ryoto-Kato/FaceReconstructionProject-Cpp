...
{ 
    ...
    // const std::string dataset_folder = std::string("../data/EURECOM_Kinect_Face_Dataset/0019/s2");
    // const std::string rgb_filename = std::string("/RGB/rgb_0019_s2_Smile.bmp");
    // const std::string depth_filename = std::string("/Depth/DepthBMP/depth_0019_s2_Smile.bmp");
