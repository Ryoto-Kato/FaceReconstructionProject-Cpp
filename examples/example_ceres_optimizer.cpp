// Exercise 5 in 3D scanning and motion capture
// This is just example of the ceres optimizer.
#include <iostream>
#include <fstream>
...
int alignBunnyWithICP() {
	...
	if (USE_LINEAR_ICP) {
		optimizer = new LinearICPOptimizer(REGULARIZER);
	}
	else {
	...
	if (USE_POINT_TO_PLANE) {
		...
		optimizer->setNbOfIterations(1000); //10
	}
	else {
