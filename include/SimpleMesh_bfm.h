...
public:
	...
	inline unsigned int getNumTriangles(){
		return num_triangles;
	}

	inline void setNumVertices(unsigned int _num_vertices){
		num_vertices = _num_vertices;
		m_vertices.reserve(num_vertices);
	}

	inline void setNumTriangles(unsigned int _num_triangles){
		num_triangles = _num_triangles;
		m_triangles.reserve(num_triangles);
	}

	inline void setVertices(std::vector<Vertex> _in_m_vertices){
		m_vertices.insert(m_vertices.begin(), _in_m_vertices.begin(), _in_m_vertices.end());
	}

	inline void setTriangles(std::vector<Triangle> _in_m_triangles){
		m_triangles.insert(m_triangles.begin(), _in_m_triangles.begin(), _in_m_triangles.end());
	}
